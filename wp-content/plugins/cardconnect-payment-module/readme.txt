...
WC Pre-Orders tested with v1.5.5
WC Subscriptions tested with v2.2.16
...
Please note that WooCommerce (v2.7+) must be installed and active.
The latest version of WooCommerce (v3.2.6) is supported.
