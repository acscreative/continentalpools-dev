...
class wfFedexRequest{
	...
	private function init() {		
		...
		$this->shipper_person_name 	= $this->settings[ 'shipper_person_name' ];
		$this->shipper_company_name	= $this->settings[ 'shipper_company_name' ];
		$this->shipper_street      	= $this->settings[ 'frt_shipper_street' ];
		$this->shipper_street_2    	= $this->settings[ 'shipper_street_2'];
		$this->shipper_city        	= $this->settings[ 'freight_shipper_city' ];
